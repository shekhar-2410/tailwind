	...
	return (
		<section className="text-gray-600 body-font">
			<div className="container px-5 py-24 mx-auto">
				<h1 className="text-3xl font-large title-font mb-5 text-black tracking-widest text-center text-gray-100">
					Testimonial
				</h1>
					...
					<div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
						<div className="h-full text-center">
							...
							<p className="leading-relaxed">
								...
								cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking
